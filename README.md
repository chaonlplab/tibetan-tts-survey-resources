...
|---|---|---|
| `data/resources.csv` | Tables II & VIII | All 12 retained Tibetan speech resources (R01–R12) with dialect, speakers, size, annotation, access status, FAIR screen, and source identifiers |
...
- `resource_id` — R01–R12, identical to the identifiers used in the paper
